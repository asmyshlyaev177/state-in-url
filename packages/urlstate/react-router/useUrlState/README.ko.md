...
<!-- i18n:meta locale=ko source=README.md source-blob=1c8bfbd0d0f5f8b7ac5ea33a5a298550b0141f5f status=translated -->
<!-- i18n:end -->

# API

이 모듈은 react-router@6-7 애플리케이션에서 URL 검색 파라미터와 동기화되는 상태를 관리하는 커스텀 React 훅을 제공합니다.
