...
<!-- i18n:meta locale=vi source=README.md source-blob=8eaf1922213c8e89f693b5213bf3cc611d332564 status=translated -->
<!-- i18n:end -->

# API

Module này cung cấp một React hook tùy chỉnh để quản lý state được đồng bộ với tham số tìm kiếm của URL trong các ứng dụng remix@2.
