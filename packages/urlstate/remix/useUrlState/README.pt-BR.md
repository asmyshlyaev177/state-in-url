...
<!-- i18n:meta locale=pt-BR source=README.md source-blob=8eaf1922213c8e89f693b5213bf3cc611d332564 status=translated -->
<!-- i18n:end -->

# API

Este módulo fornece um hook React personalizado para gerenciar o estado sincronizado com os parâmetros de busca da URL em aplicações remix@2.
