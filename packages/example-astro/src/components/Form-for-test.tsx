...
export const Form = ({
  ...
  const { urlState, setState, setUrl, reset } = useUrlState(form, {
    searchParams,
    replace: searchParams?.replace === 'false' ? false : true,
  });
  ...
  return (
    <div className={className}>
      <div className="border-grey flex-1 rounded-md border p-4 shadow-md">
        <div className="mb-4 font-semibold">First island</div>
...
const Button = ({
  ...
  return (
    <button
      onClick={onClick}
      className="rounded-md border border-black px-2 py-1 text-black"
